...
const expected={
  manufacturer:'NORTHSTAR PROCESS EQUIPMENT',purchaser:'BLUE RIDGE ENERGY SYSTEMS',serial:'V-26-0417',year:'2026',
  ...
  'innerHead.1.knuckle':'3.0','innerHead.1.efficiency':'85','innerHeadFlange.1.type':'SO','innerHeadFlange.1.boltMaterial':'SA193-B8M',
...
assert.ok(!fields.some(field=>/bolting quality|bolting size/i.test(field.label)||/\.bolt(?:Quality|Size)$/.test(field.id)));
