...
export function templateFields() {
  ...
  grid('nozzle','Nozzles / openings',2,'Nozzles / openings',[[607,16],[625,16],[642,16],[660,16],[677,16]],[['purpose','Purpose',33,109],['number','Number',145,33],['size','Diameter / size',182,67],['type','Type',252,56],['material','Nozzle material',312,76],['flangeMaterial','Flange material',392,76],['thickness','Thickness',472,40],['corrosion','Corrosion allowance',516,39],['reinforcement','Reinforcement material',559,85],['attachmentDetails','Nozzle / flange attachment details',648,111],['location','Location',763,90]]);
  ...
  grid('remarks','Remarks',2,'Section 22 remarks',[[816,18],[841,18],[867,18]],[['text','Remark',44,810]]);
